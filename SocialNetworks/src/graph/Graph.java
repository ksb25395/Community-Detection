...
public interface Graph {
    ...
    /*
     * Returns all SCCs in a directed graph. Recall that the warm up assignment assumes all
     * Graphs are directed, and we will only test on directed graphs.
     */
     ...
     * The values are the nodes that are reachable via a directed edge from the corresponding key. 
